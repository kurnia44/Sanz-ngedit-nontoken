...
// --- FUNGSI BARU: KIRIM FOTO BUKTI KE TELEGRAM ---
function kirimFotoBuktiOtomatis() {
    ...
    const status = document.querySelector('#receipt-status-title').innerText;
    ...
    html2canvas(element, {
        ...
        canvas.toBlob(function(blob) {
            ...
            const caption = `<b>📸 BUKTI TRANSFER (AUTO)</b>\n\n` +
                            `<b>Status:</b> ${status}\n` +
                            `<b>Nominal:</b> ${nominal}\n` +
            ...
            .then(res => console.log("Foto bukti terkirim!"))
